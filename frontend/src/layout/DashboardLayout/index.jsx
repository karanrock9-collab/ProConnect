...
//             return (
//               <div key={profile_.id} className={styles.extraContainer__profile}>
...
//         <div className={styles.homeContainer__feedContainer}></div>
            ...
            authState.all_users.map((profile) => {
              return (
                <div
                  ...
                  className={styles.extraContainer__profile}
                  onClick={() => {
                    console.log("Top profile clicked!", profile);
